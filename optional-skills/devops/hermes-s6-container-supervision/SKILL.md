...
| `docker/s6-rc.d/dashboard/run` | Conditional dashboard service — disabled unless `HERMES_DASHBOARD` is truthy; the run hook exits and its finish hook leaves the s6 slot down when disabled. |
