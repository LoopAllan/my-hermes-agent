    ...
    def _is_user_authorized(
        ...
        *,
        ...
        if chat_allowlist_env and source.chat_id:
            # _platform_gate_env, not os.getenv: under multiplex the process env
            # may hold another profile's first-writer-bridged allowlist (#72348).
        ...
        if source.chat_type in {"group", "forum", "channel"} and source.chat_id:
            ...
            # Guarded on chat_type rather than chained onto the env check above:
            # platforms with no allowlist env var at all must still reach it.
            try:
